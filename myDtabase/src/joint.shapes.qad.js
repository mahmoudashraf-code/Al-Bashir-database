joint.dia.Element.define('qad.Question', {
    ...
    initialize: function () {
        ...
        this.on('change:question', function () {
            this.attr('.question-text/text', this.get('name') || '');
            this.autoresize();
        }, this);
        ...
        this.attr('.options/refY', this.get('questionHeight'), { silent: true });
        this.attr('.question-text/text', this.get('name'), { silent: true });
    ...
    autoresize: function () {
        ...
        var width = joint.util.measureText(this.get('name'), {
...
joint.shapes.qad.QuestionView = joint.dia.ElementView.extend({
    ...
    onAddOption: function () {
        this.model.addOption({
            ...
            text: 'attribute ' + (this.model.get('options').length + 1)
        });
    },
